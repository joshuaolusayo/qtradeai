...
export default function GEI(): JSX.Element {
        ...
        <div className="p-4 md:p-6 lg:p-10 min-h-screen">
          ...
          <div className="my-8 py-8 text-center border border-purple bg-gray-50 rounded-md md:px-16 lg:px-20">
            ...
            <p className="text-gray-500 hidden md:block">
              GEI Revenue Share BRONZE PRO + TAX. 40% of your Empowerment is credited in Your MN
              daily wallet for 30 days. 60% of your Empowerment is credited into GEI empowerment
              wallet for 30 days. After 30 days the wallet is unlocked if you have sponsored a
              minimum of 5 members of the same package or Above. The default of not sponsoring 5
              members within 30 days attract a 20% fine on your empowerment wallet whenever you
              complete the requirement, ur wallet remains Lock until the requirement is achieved
            </p>
          </div>
